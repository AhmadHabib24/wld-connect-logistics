...
@section('description', 'Get in touch with WLD Connect Logistics for all your logistics needs. Contact our expert team for quotes, consultations, and customer support.')
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="max-w-4xl mx-auto text-center fade-in-up">
            ...
            <p class="text-xl lg:text-2xl text-blue-100 leading-relaxed">
                Ready to optimize your logistics? Get in touch with our expert team for personalized solutions and exceptional service.
            </p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div class="fade-in-up stagger-animation" style="--delay: 0.2s;">
                ...
                <div class="space-y-8">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 mb-2">
                                <a href="tel:+1-800-555-0123" class="hover:text-red-600 transition-colors">+1 (800) 555-0123</a>
                            </p>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 mb-1">
                                <a href="mailto:info@wldconnect.com" class="hover:text-red-600 transition-colors">info@wldconnect.com</a>
                            </p>
                            <p class="text-gray-600 mb-1">
                                <a href="mailto:quotes@wldconnect.com" class="hover:text-red-600 transition-colors">quotes@wldconnect.com</a>
                            </p>
                    ...
                    <!-- Emergency Contact -->
                    <div class="flex items-start space-x-4">
                        <div class="w-12 h-12 bg-yellow-100 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 mb-2">
                                <a href="tel:+1-800-555-HELP" class="hover:text-red-600 transition-colors">+1 (800) 555-HELP</a>
                            </p>
...
<section class="bg-gray-50 py-20">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <!-- Europe -->
            <div class="bg-white rounded-2xl p-8 shadow-lg hover-lift fade-in-up stagger-animation" style="--delay: 0.1s;">
            ...
            <div class="space-y-6">
                <div class="border border-gray-200 rounded-lg fade-in-up">
                    <button class="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 transition-colors" onclick="toggleFAQ('faq1')">
                        ...
                        <svg class="w-5 h-5 text-gray-500 transform transition-transform" id="faq1-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <div class="hidden px-6 pb-4" id="faq1-content">
                        <p class="text-gray-600">You can get a free quote by filling out our contact form above, calling us directly, or emailing quotes@wldconnect.com. Please include origin/destination, cargo details, weight/dimensions, and timeline for accurate pricing.</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg fade-in-up stagger-animation" style="--delay: 0.1s;">
                    <button class="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 transition-colors" onclick="toggleFAQ('faq2')">
                        ...
                        <svg class="w-5 h-5 text-gray-500 transform transition-transform" id="faq2-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <div class="hidden px-6 pb-4" id="faq2-content">
                        <p class="text-gray-600">We provide shipping services to over 50 countries worldwide. Our global network covers North America, Europe, Asia Pacific, and many other regions. Contact us for specific destination availability.</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg fade-in-up stagger-animation" style="--delay: 0.2s;">
                    <button class="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 transition-colors" onclick="toggleFAQ('faq3')">
                        ...
                        <svg class="w-5 h-5 text-gray-500 transform transition-transform" id="faq3-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <div class="hidden px-6 pb-4" id="faq3-content">
                        <p class="text-gray-600">Yes, we provide comprehensive customs clearance services including documentation preparation, duty calculations, and regulatory compliance. Our experienced customs brokers ensure smooth international shipments.</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg fade-in-up stagger-animation" style="--delay: 0.3s;">
                    <button class="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 transition-colors" onclick="toggleFAQ('faq4')">
                        ...
                        <svg class="w-5 h-5 text-gray-500 transform transition-transform" id="faq4-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <div class="hidden px-6 pb-4" id="faq4-content">
                        <p class="text-gray-600">Absolutely! We provide real-time tracking for all shipments through our online portal and mobile app. You'll receive updates at key milestones and can track your cargo 24/7.</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg fade-in-up stagger-animation" style="--delay: 0.4s;">
                    <button class="w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 transition-colors" onclick="toggleFAQ('faq5')">
                        ...
                        <svg class="w-5 h-5 text-gray-500 transform transition-transform" id="faq5-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <div class="hidden px-6 pb-4" id="faq5-content">
                        <p class="text-gray-600">We handle various cargo types including general freight, temperature-sensitive goods, hazardous materials, oversized cargo, and high-value items. Our specialized handling ensures safe transportation for all cargo types.</p>
                    </div>
                </div>
            </div>
        </div>
