...
@section('description', 'State-of-the-art warehousing facilities with advanced inventory management systems,
    climate-controlled environments, and 24/7 security monitoring.')
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="max-w-4xl mx-auto text-center fade-in-up">
                ...
                <p class="text-xl lg:text-2xl text-blue-100 leading-relaxed mb-8">
                    State-of-the-art storage facilities with advanced inventory management systems designed to keep your
                    goods secure and accessible.
                </p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="fade-in-up">
                    ...
                    <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                        Our modern warehousing facilities are equipped with cutting-edge technology and managed by
                        experienced professionals to ensure your inventory is stored safely, organized efficiently, and
                    ...
                    <div class="space-y-6">
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-blue-800">Temperature and humidity-controlled storage for sensitive goods
                                    requiring specific environmental conditions.</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-green-800">Advanced WMS technology providing real-time visibility of your
                                    inventory levels and locations.</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-red-800">Round-the-clock security with CCTV surveillance, access control, and
                                    trained security personnel.</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white rounded-xl p-8 shadow-lg hover-lift fade-in-up">
                    ...
                    <p class="text-gray-600">Advanced WMS with barcode scanning, cycle counting, and automated reporting
                        for complete inventory control.</p>
                </div>
                ...
                <div class="bg-white rounded-xl p-8 shadow-lg hover-lift fade-in-up stagger-animation"
                    ...
                    <p class="text-gray-600">Efficient cross-docking services to minimize storage time and reduce handling
                        costs for time-sensitive shipments.</p>
                </div>
                ...
                <div class="bg-white rounded-xl p-8 shadow-lg hover-lift fade-in-up stagger-animation"
                    ...
                    <p class="text-gray-600">Professional order fulfillment services with accurate picking, quality
                        packing, and shipping preparation.</p>
                </div>
                ...
                <div class="bg-white rounded-xl p-8 shadow-lg hover-lift fade-in-up stagger-animation"
                    ...
                    <p class="text-gray-600">Comprehensive documentation and detailed reporting for complete transparency
                ...
                <div class="bg-white rounded-xl p-8 shadow-lg hover-lift fade-in-up stagger-animation"
                    ...
                    <p class="text-gray-600">Comprehensive security measures and insurance coverage to protect your
                        valuable inventory at all times.</p>
                </div>
                ...
                <div class="bg-white rounded-xl p-8 shadow-lg hover-lift fade-in-up stagger-animation"
                    ...
                    <p class="text-gray-600">Fast receiving, processing, and dispatch capabilities to keep your supply
                        chain moving efficiently.</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="fade-in-up">
                    ...
                    <div class="space-y-6">
                        <div class="border-l-4 border-red-600 pl-6">
                            ...
                            <p class="text-gray-600">Over 500,000 square feet of modern warehouse space across multiple
                                locations</p>
                        </div>

                        <div class="border-l-4 border-blue-600 pl-6">
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Temperature Control</h3>
                            <p class="text-gray-600">Climate-controlled environments from -20°C to +25°C with humidity
                                control</p>
                        </div>

                        <div class="border-l-4 border-green-600 pl-6">
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Ceiling Height</h3>
                            <p class="text-gray-600">Clear ceiling heights up to 12 meters for high-density racking systems
                            </p>
                        </div>

                        <div class="border-l-4 border-purple-600 pl-6">
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Loading Capabilities</h3>
                            <p class="text-gray-600">48 dock doors with hydraulic levelers and dock seals for efficient
                                loading</p>
                        </div>

                        <div class="border-l-4 border-yellow-600 pl-6">
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Fire Safety</h3>
                            <p class="text-gray-600">Advanced sprinkler systems, smoke detection, and emergency response
                                protocols</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover-lift fade-in-up">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-4xl font-bold text-gray-900 mb-2">$2.50<span class="text-lg text-gray-600">/sq
                                ft/month</span></div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-xl hover-lift fade-in-up stagger-animation border-2 border-red-600 relative"
                    ...
                    <div class="text-center mb-8">
                        ...
                        <div class="text-4xl font-bold text-gray-900 mb-2">$3.75<span class="text-lg text-gray-600">/sq
                                ft/month</span></div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="max-w-4xl mx-auto fade-in-up">
                ...
                <p class="text-xl text-blue-100 mb-8 leading-relaxed">
                    Contact our warehousing experts today to discuss your storage requirements and get a customized solution
                    for your business.
                </p>
